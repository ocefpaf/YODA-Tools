...
from yodatools.excelparser.generate.timeseries.v0_3_2.timeseries_dao import TimeseriesXlDao
...
class TimeseriesYoda(object):
    ...
    def get_timeseriesresults(self):
        ...
        for tr in tresults:
            ...
            uObj = getattr(tr, 'IntendedTimeSpacingUnit',None)
            if uObj:
                setattr(tr,"IntendedTimeSpacingUnitsObj",self._references[uObj.UnitsName])
